...
def dashboard_view(template: str = "base::dashboard_page.html"):
    ...
    return render_page(
        ...
        hx_change_project_url="/content",
        hx_change_project_target="#div_body_content",
    )


def dashboard_view_content(template: str = "base::dashboard_body.html"):
